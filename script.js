...
var questions = [
  ...
  [
    "The BODY Tag is usually used after ____.",
    "HTML Tag",
    "p Tag",
    "title Tag",
    "Math",
...
function renderQuestion() {
  ...
  if (pos >= questions.length) {
    quiz.innerHTML =
      ...
      " of " +
      questions.length +
      " questions correct<br><br><br> Your final score is: " +
      totalScore +
      ".</h2><hr><br>Enter initials: " +
      "<input type='text' id='initials' required minlength='1' maxlength='3'><button  id='submitInitial' style='background-color: lightseagreen; color: white;'> Submit </button>";
    let initialsEl = document.getElementById("initials");
    ...
    submitInitBtn.addEventListener("click", function (event) {
      ...
      if (initialsEl.value == "" || initialsEl.value == null) {
        resultEl.innerHTML =
          "<p style= 'color: red;'>Invalid input. Please enter your initials!</p>";
      } else {
  ...
  _("test_status").innerHTML =
    "Question " + (pos + 1) + " of " + questions.length + "<br><br>";
